mod get {
    ...
    fn config_get(input: &str) -> BString {
        ...
        file.raw_value_mut("a.k").unwrap().get().unwrap().into_owned()
    }
    ...
    fn value_is_correct() -> crate::Result {
        ...
        let value = config.raw_value_mut("core.a")?;
...
mod set_string {
    ...
    fn assert_set_string(expected: &str) {
        ...
        for input in [
            ...
            let mut v = file.raw_value_mut("a.k").unwrap();
    ...
    fn simple_value_and_empty_string() -> crate::Result {
        ...
        let mut value = config.raw_value_mut("core.a")?;
...
"#,
        ...
        let mut value = config.raw_value_mut("core.e")?;
...
mod delete {
    ...
    fn single_line_value() -> crate::Result {
        ...
        let mut value = config.raw_value_mut("core.c")?;
        value.delete();
        assert_eq!(
            config.to_string(),
            "[core]\n            \n        [core]\n            \n            e=f\n",
